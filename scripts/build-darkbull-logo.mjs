/**
 * Build Dark Bull UI logo from pipeline/references/bulllogounedited.jpg.
 * Transparent PNG - flat blue bull art, no white outline.
 * Used for carousel emblem + special-move flash overlay.
 * Output: assets/logos/darkbull_logo.png
 */
...
const INPUT = resolve(ROOT, 'pipeline/references/bulllogounedited.jpg');
