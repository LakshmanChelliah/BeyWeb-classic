...
export const LAUNCH_PRESETS = {
  ...
  // Match Star Blast slam bounce hop feel (STAR_BOUNCE_* constants).
  // driftScale ~1 so kbMag=STAR_BLAST_HIT_KNOCKBACK travels like Star Blast's shove distance.
  ldrago: {
    peakLift: 9.5,
    riseDur: 0.42,
    gravity: 42,
    ...
    settleDur: 1.35,
    settleHops: 3,
    settleHopHeight: 0.32,
    settleWobbles: 3,
    settleWobbleAmp: 0.08,
    driftScale: 1.0,
    driftDur: 1.35,
    landKbScale: 0.2,
    wobbleAmp: 0.18,
