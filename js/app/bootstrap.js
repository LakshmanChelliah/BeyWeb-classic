import { createGame } from '../game/engine.js?v=74';
import { applyAISteering, tickAIAbilities, resetAIController } from '../input/ai.js';
import { createBeySelection } from '../ui/selection.js';
import { createPlaySetup } from '../ui/playSetup.js?v=74';
import { queryGameUi } from '../ui/domRefs.js';
import { createCampaignController } from '../game/campaignController.js?v=74';
...
import {
  getArenaSkinForBey,
  resolveArenaSkinId,
} from '../render/arenaSkins.js?v=74';
import { getTournamentBlader } from '../game/campaign.js';
import { playArenaTransition } from '../ui/arenaTransition.js?v=74';
