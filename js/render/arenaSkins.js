...
export const ARENA_SKINS = Object.freeze([
  Object.freeze({
    ...
    desc: "Benkei's training ground — concrete dish under scaffolding and hazard lamps",
    backdrop: {
      style: 'construction',
      top: '#1a1520',
      mid: '#2a2018',
  ...
  Object.freeze({
    ...
    desc: "Tsubasa's polished indoor arena — silver dish under theater spotlights",
    backdrop: {
      style: 'wbba_hq',
      top: '#0c1424',
      mid: '#1a2840',
  ...
  Object.freeze({
    ...
    desc: "Kyoya's daytime rooftop stadium — stone dish above the city skyline",
    backdrop: {
      style: 'rooftop_day',
      top: '#5eb0e8',
      mid: '#87ceeb',
  ...
  Object.freeze({
    ...
    fogFar: 125,
    name: 'Koma Village',
    desc: "Gingka's home ground — rough polished rock dish among relics and ruins",
    backdrop: {
      style: 'koma_village',
      top: '#6a90b0',
      mid: '#8ab0a0',
    ...
    platformVein: '#6a7050',
    platformGrid: '#484038',
    platformRoughness: 0.52,
    platformMetalness: 0.14,
    base: 0x1a2018,
  }),
  Object.freeze({
    id: 'dragons_maw',
