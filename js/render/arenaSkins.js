...
export const ARENA_SKINS = Object.freeze([
  ...
  Object.freeze({
    ...
    // Dark charcoal tournament dish (anime still)
    dishCenter: '#5a6068',
    dishMid: '#3a4048',
    dishEdge: '#1e2228',
    dishLip: 0x6a7078,
  ...
  Object.freeze({
    ...
    desc: "Ryuga's forbidden roof — elevated deck over a night city of towers",
    placement: 'elevated',
    backdrop: {
